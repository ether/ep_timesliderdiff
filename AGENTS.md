...
`ep_timesliderdiff` runs inside Etherpad's test harness. From an etherpad checkout that has installed this plugin via `pnpm run plugins i --path ../ep_timesliderdiff`:
...
* Server: `eejsBlock_timesliderStyles`, `eejsBlock_timesliderEditbarRight`, `eejsBlock_timesliderBody`
